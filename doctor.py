...
# Set page config
st.set_page_config(page_title="Virtual image analytics", page_icon=":robot:")

# Set logo
# st.image("logo.jpeg", width=200)  # Adjust width as needed

# Title
st.title("Virtual image analytics")

#set subtitle
st.header("the appli action that helps users like me ")
